...
*   **Flexible Validation Framework (HMA v2.1):** #hma-glossary-term Architecture allowing JSON Schema compliance at boundaries with alternative validation internally.

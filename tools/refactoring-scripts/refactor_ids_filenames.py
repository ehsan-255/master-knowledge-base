...
if __name__ == "__main__":
    # Example: python tools/refactor_ids_filenames.py standards/src --dry-run
    # Example: python tools/refactor_ids_filenames.py standards/src standards/registry --dry-run

...
class PathReferenceUpdater:
    ...
    def __init__(self, repo_root: Path, dry_run: bool, logger: logging.Logger):
        ...
        self.replacement_patterns = [
            ...
            (r'master-knowledge-base/standards/', 'standards/'),
            (r'master-knowledge-base/tools/', 'tools/'),
            (r'master-knowledge-base/dist/', 'dist/'),
            (r'/master-knowledge-base/standards/', '/standards/'),
            (r'/master-knowledge-base/tools/', '/tools/'),
            (r'/master-knowledge-base/dist/', '/dist/'),
        ...
        self.python_patterns = [
            ...
            (r'Path\("master-knowledge-base/([^"]+)"\)', r'Path("\1")'),
            
            # String path references
            (r'"master-knowledge-base/([^"]+)"', r'"\1"'),
            (r"'master-knowledge-base/([^']+)'", r"'\1'"),
        ...
        self.special_files = {
            'master-knowledge-base/tools/naming-enforcer/naming_enforcer.py': self.update_naming_enforcer,
            'master-knowledge-base/tools/linter/kb_linter.py': self.update_kb_linter,
            'master-knowledge-base/tools/naming-enforcer/generate_naming_configs.py': self.update_naming_configs,
            'master-knowledge-base/dist/standards_index.json': self.update_standards_index,
        }
        ...
        try:
            ...
            if content != original_content:
                if self.dry_run:
                    ...
                    self.log_changes(file_path, original_content, content)
                else:
    ...
    def update_kb_linter(self, file_path: Path) -> bool:
        ...
        try:
            ...
            content = re.sub(
                r'default="master-knowledge-base/standards/src"',

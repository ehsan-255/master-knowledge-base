...
tags:
  ...
  - content-type/policy-document # Assuming this is the correct tag from your glossary
kb-id: "" # Global policy
...
primary_domain: "CS" # Content Standards, as per prompt suggestion
sub_domain: "POLICY" # Content Policies
...
criticality: "P2-Medium"
lifecycle_gatekeeper: "Editorial-Board-Approval" # Policies might go through an editorial board
impact_areas: ["User experience", "KB navigability", "Authoring consistency", "Maintainability"]
change_log_url: "./CS-POLICY-KB-ROOT-changelog.md" # Placeholder
---
